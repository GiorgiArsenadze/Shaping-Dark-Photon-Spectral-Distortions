...
params = {'_internal.classic_mode': False,
 ...
 'axes.labelweight': 'normal',
 'axes.linewidth': 1.8,
 'axes.prop_cycle': (cycler('color', ['#c6383a', '#4a7ca5', '#5ba059', '#8f5b96', '#d97f26', '#e0e052', '#935b3b', '#e593be', '#999999', '#c6383a']) + cycler('alpha', [0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9])),
 'axes.spines.bottom': True,
 'axes.spines.left': True,
 'axes.spines.right': True,
 'axes.spines.top': True,
